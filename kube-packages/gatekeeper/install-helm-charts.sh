...
sed -i "s|repository: openpolicyagent/\(.*\)|repository: registry.local.cloud:5000/openpolicyagent/\1|g" ${BASEDIR}/installed-values.yaml
sed -i "s|crdRepository: openpolicyagent/\(.*\)|crdRepository: registry.local.cloud:5000/openpolicyagent/\1|g" ${BASEDIR}/installed-values.yaml
